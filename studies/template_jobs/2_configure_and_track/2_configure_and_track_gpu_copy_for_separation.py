# Copy of separation at ADJUST with imported collider before modification for longer tracking
...
def configure_and_track(config_path="config.yaml"):
    ...
    new_folder = 'Separation_adjust/MD_4x36b_optics23_adjust_1m_particles_qgaus1.4'
